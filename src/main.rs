...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    let csp = init_problem(test_case_path);
...
fn init_problem(test_case_path: String) -> Result<CSP,  Box<dyn Error>> {
    ...
    let row_pos_poles: Vec<u32> = test_case_lines
        .get(1)
    ...
    let row_neg_poles: Vec<u32> = test_case_lines
        .get(2)
    ...
    let col_pos_poles: Vec<u32> = test_case_lines
        .get(3)
    ...
    let col_neg_poles: Vec<u32> = test_case_lines
        .get(4)
